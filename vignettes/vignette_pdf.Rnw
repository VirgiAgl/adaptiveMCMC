...
df1<-data.frame(x=iteration,y=X_MH_banana$acceptance_rates)
df2<-data.frame(x=iteration,y=X_AM_banana$acceptance_rates)
df3<-data.frame(x=iteration,y=X_AM2_banana$acceptance_rates)
df4<-data.frame(x=iteration,y=X_AM_banana_sh$acceptance_rates)
df5<-data.frame(x=iteration,y=X_AM2_banana_sh$acceptance_rates)
df6<-data.frame(x=iteration,y=X_AM_banana_th$acceptance_rates)
df7<-data.frame(x=iteration,y=X_AM2_banana_th$acceptance_rates)
df8<-data.frame(x=iteration, y=rep(0.234,n_iter+1))
